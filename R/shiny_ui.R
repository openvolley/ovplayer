...
$(document).on('shiny:sessioninitialized', function() {
    ...
    tags$style(HTML(".showhide {border-radius: 20px; padding: 6px 9px; background: #668;} .showhide:hover {background: #668;} .showhide:focus {background: #668;} #video_holder:not(:fullscreen) #dvyt_player {height:480px;} #video_holder:fullscreen #dvyt_player {height:100vh;} table.dataTable tbody tr.selected > * { color: black; }"))
),
