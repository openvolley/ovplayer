...
ovp_shiny_mobile_ui <- function(app_data) {
    f7Page(
        ...
        # } else {
            ...
            #          column(3, offset = 3, tags$div(style = "text-align: center;", "Part of the", tags$br(), tags$img(src = "data:image/svg+xml;base64,", style = "max-height:3em;"), tags$br(), tags$a(href = "https://github.com/openvolley", "openvolley", target = "_blank"), "project")))
        # },
        #tags$div(style = "text-align: center;", "Part of the", tags$br(), tags$img(src = "data:image/svg+xml;base64,", style = "max-height:3em;"), tags$br(), tags$a(href = "https://github.com/openvolley", "openvolley", target = "_blank"), "project"),
        #tags$hr(),
...
ovp_shiny_ui_mobile_main <- function() {
    f7SingleLayout(
        navbar = f7Navbar(
            title = "Volleyball Video Player",
            hairline = TRUE,
        ...
        toolbar = f7Toolbar(
            position = "bottom",
            uiOutput("player_controls_start_ui"),
            uiOutput("player_controls_prev_ui"),
            uiOutput("player_controls_next_ui"),
            uiOutput("player_controls_play_pause_ui"),
            uiOutput("player_controls_back_ui")
        ),
        f7Shadow(
            intensity = 16,
            hover = TRUE,
